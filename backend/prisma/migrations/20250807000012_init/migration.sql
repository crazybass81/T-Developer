...
-- CreateEnum
CREATE TYPE "AgentType" AS ENUM ('CODE_GENERATOR', 'CODE_REVIEWER', 'TEST_GENERATOR', 'DOCUMENTATION', 'DEPLOYMENT', 'MONITORING', 'SECURITY', 'PERFORMANCE', 'PROJECT_MANAGER');
...
-- AddForeignKey
ALTER TABLE "agents" ADD CONSTRAINT "agents_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "projects"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
