...
class TemplateMatcher:
    ...
    def _initialize_templates(self):
        ...
        self.templates = {
            ...
            'blog_platform': {
                'patterns': ['blog', 'blogging platform', 'content management', 'writing platform'],
                'project_type': 'blog',
            ...
            'ecommerce_basic': {
                ...
                'features': ['auth', 'database', 'payment', 'cart', 'search', 'responsive'],
                'tech_stack': {
                    'frontend': ['nextjs', 'typescript', 'tailwind'],
                    'backend': ['nodejs', 'express'],
                    'database': ['postgresql'],
            ...
            'admin_dashboard': {
                'patterns': ['admin dashboard', 'analytics dashboard', 'monitoring dashboard'],
            ...
            'chat_app': {
                'patterns': ['chat app', 'messaging app', 'real-time chat', 'messenger'],
                'project_type': 'chat',
                'features': ['auth', 'database', 'realtime', 'notification', 'responsive'],
                'tech_stack': {
    ...
    def _calculate_match_confidence(self, text: str, template: Dict) -> float:
        ...
        if any(f"create {pattern}" in text or f"build {pattern}" in text 
               for pattern in template['patterns']):
            confidence += 0.1
