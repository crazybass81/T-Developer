...
class InfrastructurePlanner:
    ...
    def _determine_infrastructure_type(self, requirements: Dict, constraints: Dict) -> InfrastructureType:
        """Determine infrastructure type"""
        ...
        return {
            ...
            'security_groups': [
                ...
                },
                {
                    'name': 'app-sg',
                    'ingress': [
                        {'port': 8080, 'protocol': 'tcp', 'source': 'web-sg'}
                    ]
                },
                {
                    'name': 'db-sg',
    ...
    def _estimate_infrastructure_costs(self, compute: Dict, storage: Dict, networking: Dict) -> Dict:
