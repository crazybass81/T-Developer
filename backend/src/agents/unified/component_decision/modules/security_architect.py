...
class SecurityArchitect:
    ...
    def _select_security_controls(self, level: SecurityLevel) -> List[str]:
        ...
        if level in [SecurityLevel.STANDARD, SecurityLevel.HIGH, SecurityLevel.CRITICAL]:
    ...
    def _generate_recommendations(self, level: SecurityLevel, vulnerabilities: List[Dict]) -> List[str]:
