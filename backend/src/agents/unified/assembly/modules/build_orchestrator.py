...
class BuildOrchestrator:
    ...
    async def orchestrate_build(
        ...
        try:
            ...
            project_path = os.path.join(workspace_path, 'source', context.get('project_name', 'project'))
    ...
    async def _collect_build_artifacts(self, project_path: str, framework: str) -> List[BuildArtifact]:
        """Collect build artifacts"""
