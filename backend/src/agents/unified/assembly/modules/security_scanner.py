...
class SecurityScanner:
    ...
    def __init__(self):
        ...
        self.compliance_checks = {
            "owasp_top_10": ["injection", "authentication", "data_exposure", "crypto"],
            "gdpr_compliance": ["data_exposure", "crypto"],
            "pci_dss": ["authentication", "crypto", "data_exposure"],
        }

    async def scan_security(
        self, analyzed_files: Dict[str, str], context: Dict[str, Any]
    ) -> SecurityResult:
        ...
        try:
            ...
            dependency_vulns = await self._scan_dependencies(analyzed_files)
    ...
    async def _scan_category(
        self, files: Dict[str, str], category: str, rules: List[Dict[str, str]]
    ...
    def _get_top_recommendations(
        self, vulnerabilities: List[SecurityVulnerability], limit: int = 5
    ) -> List[str]:
