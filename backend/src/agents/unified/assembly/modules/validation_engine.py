...
class ValidationEngine:
    ...
    async def validate_project(
        self, optimized_files: Dict[str, str], context: Dict[str, Any]
    ) -> ValidationResult:
        ...
        try:
            ...
            quality_issues = await self._validate_code_quality(optimized_files, context)
            issues.extend(quality_issues)

            # Security validation
            security_issues = await self._validate_security(optimized_files, context)
