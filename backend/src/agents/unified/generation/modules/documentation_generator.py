...
class DocumentationGenerator:
    ...
    async def _generate_readme(self, context: Dict[str, Any]) -> DocumentationFile:
        ...
        project_name = context.get('project_name', 'Generated Project')
        framework = context.get('target_framework', 'react')
        description = context.get('project_description', f'A {framework} application generated by T-Developer')
...
"""
    ...
    async def _generate_code_comments(self, context: Dict[str, Any]) -> Dict[str, DocumentationFile]:
