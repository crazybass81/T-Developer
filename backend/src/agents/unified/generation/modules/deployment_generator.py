...
class DeploymentGenerator:
    ...
    async def generate_deployment_configs(
        ...
        try:
            ...
            return DeploymentResult(
                ...
                metadata={'framework': framework, 'targets': [t.value for t in targets]}
            )
    ...
    def _get_deployment_targets(self, framework: str, context: Dict[str, Any]) -> List[DeploymentTarget]:
    ...
    async def _generate_docker_configs(self, context: Dict[str, Any]) -> Dict[str, DeploymentConfig]:
    ...
    async def _generate_netlify_configs(self, context: Dict[str, Any]) -> Dict[str, DeploymentConfig]:
    ...
    async def _generate_vercel_configs(self, context: Dict[str, Any]) -> Dict[str, DeploymentConfig]:
            ...
            compose_config = {
                ...
                'services': {
                    'app': {
                        ...
                        'ports': ['8000:8000'],
                        'environment': [
                            'NODE_ENV=production' if framework == 'express' else 'ENVIRONMENT=production'
                        ],
                        'depends_on': ['db']
                    },
                    'db': {
