...
class ConfigurationGenerator:
    ...
    async def _generate_common_configs(self, context: Dict[str, Any]) -> Dict[str, ConfigurationFile]:
    ...
    async def _generate_environment_configs(self, context: Dict[str, Any]) -> Dict[str, ConfigurationFile]:
    ...
    async def _generate_security_configs(self, context: Dict[str, Any]) -> Dict[str, ConfigurationFile]:
    ...
    async def _generate_build_configs(self, context: Dict[str, Any]) -> Dict[str, ConfigurationFile]:
...
CMD ["uvicorn", "main:app", "--host", "0.0.0.0", "--port", "8000"]"""
    ...
    async def _get_github_actions_configs(self, context: Dict[str, Any]) -> Dict[str, ConfigurationFile]:
            ...
            'jobs': {
                'test': {
                    ...
                    'steps': [
                        ...
                        {
                            'name': 'Setup Node.js' if framework in ['react', 'vue', 'angular', 'express'] else 'Setup Python',
                            'uses': 'actions/setup-node@v3' if framework in ['react', 'vue', 'angular', 'express'] else 'actions/setup-python@v3',
                            'with': {
                                'node-version': '18' if framework in ['react', 'vue', 'angular', 'express'] else None,
                                'python-version': '3.9' if framework not in ['react', 'vue', 'angular', 'express'] else None
                            }
                        },
                        {
                            'name': 'Install dependencies',
                            'run': 'npm ci' if framework in ['react', 'vue', 'angular', 'express'] else 'pip install -r requirements.txt'
                        },
                        {
                            'name': 'Run tests',
                            'run': 'npm test' if framework in ['react', 'vue', 'angular', 'express'] else 'pytest'
                        },
                        {
                            'name': 'Build',
                            'run': 'npm run build' if framework in ['react', 'vue', 'angular', 'express'] else 'python -m build'
                        }
                    ]
                }
            }
...
VITE_SENTRY_DSN=${SENTRY_DSN}"""
    ...
    async def _get_editorconfig_configs(self, context: Dict[str, Any]) -> Dict[str, ConfigurationFile]:
    ...
    async def _get_rate_limiting_config(self, context: Dict[str, Any]) -> Dict[str, ConfigurationFile]:
