...
class TestingGenerator:
            ...
            for test_type, test_framework in test_setup.items():
                ...
                if test_files:
                    ...
                    suite = TestSuite(
                        ...
                        configuration=await self._get_test_configuration(test_framework_enum, context),
    ...
    async def _generate_api_tests(
        ...
        api_components = [c for c in components if c.get('category') == 'api' or 'api' in c.get('type', '')]
...
class Test{component_name}Service:
    ...
    def _generate_jest_integration_test(self, components: List[Dict[str, Any]], context: Dict[str, Any]) -> str:
...
describe('API Integration Tests', () => {
  ...
  it('should handle authentication flow', async () => {
    ...
    def _generate_cypress_e2e_test(self, components: List[Dict[str, Any]], context: Dict[str, Any]) -> str:
...
async def client():
    ...
    async def _get_test_configuration(self, framework: TestFramework, context: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _generate_coverage_config(self, framework: str, context: Dict[str, Any]) -> Dict[str, Any]:
        """Generate coverage configuration"""
    ...
    def _generate_pytest_integration_test(self, components: List[Dict[str, Any]], context: Dict[str, Any]) -> str:
        return "# Pytest integration test content"
    
    def _generate_playwright_e2e_test(self, components: List[Dict[str, Any]], context: Dict[str, Any]) -> str:
        return "// Playwright E2E test content"
    
    def _generate_jest_api_test(self, components: List[Dict[str, Any]], context: Dict[str, Any]) -> str:
        return "// Jest API test content"
    
    def _generate_pytest_api_test(self, components: List[Dict[str, Any]], context: Dict[str, Any]) -> str:
        return "# Pytest API test content"
    
    def _generate_react_component_test(self, component: Dict[str, Any], context: Dict[str, Any]) -> str:
