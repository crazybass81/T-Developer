...
class QualityChecker:
    ...
    def __init__(self):
        ...
        self.security_patterns = {
            ...
            "insecure_random": [r"Math\.random\(", r"random\.choice\(", r"rand\("],
        }
        ...
        self.performance_patterns = {
            ...
            "blocking_operations": [r"fs\.readFileSync\(", r"\.sync\(\)", r"sleep\("],
        }
    ...
    async def _analyze_file(
        self, file_path: str, language: str, framework: str
    ...
    async def _analyze_code_smells(
        ...
        for i, line in enumerate(lines, 1):
            ...
            if (
                "function " in line
                or "def " in line
                or ("(" in line and "{" in line and not line.strip().startswith("//"))
            ):
                in_method = True
                method_start_line = i
                method_lines = 1
                ...
                if "}" in line or (
                    language == "python" and line.strip() and not line.startswith(" ")
                ):
    ...
    def _aggregate_metrics(
        self, current: QualityMetrics, file_metrics: Dict[str, Any]
    ) -> QualityMetrics:
        ...
        return QualityMetrics(
            ...
            + file_metrics.get("cyclomatic_complexity", 0),
            ...
            technical_debt_hours=current.technical_debt_hours
            + file_metrics.get("issues_count", 0) * 0.5,
    ...
    def _calculate_derived_metrics(
        self, metrics: QualityMetrics, file_count: int
    ) -> QualityMetrics:
        """Calculate derived metrics"""
    ...
    async def _generate_recommendations(
        self, metrics: QualityMetrics, issues: List[QualityIssue], framework: str
    ) -> List[str]:
    ...
    def _merge_framework_metrics(
        self, base_metrics: QualityMetrics, framework_metrics: Dict[str, Any]
    ) -> QualityMetrics:
