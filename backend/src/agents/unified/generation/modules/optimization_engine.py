...
const ContactPage = lazy(() => import('./pages/ContactPage'));"""
            ...
            actions.append(OptimizationAction(
                ...
                trade_offs=["Slightly longer loading time for subsequent pages", "Need to handle loading states"]
            ))
...
import Dialog from '@mui/material/Dialog';"""
    ...
    async def _optimize_bundle_size(
        ...
        actions.append(OptimizationAction(
            ...
            trade_offs=["Need fallback for older browsers", "More complex image handling"]
        ))
...
const MemoizedItem = React.memo(Item);"""
            ...
            actions.append(OptimizationAction(
                ...
                trade_offs=["Slightly more complex code", "Memory overhead for memoization"]
            ))
  ...
  res.json(users);
                ...
                actions.append(OptimizationAction(
                    ...
                    trade_offs=["More complex query", "Potentially more data transferred"]
                ))
    ...
    for item in data:
        yield expensive_operation(item)"""
            ...
            actions.append(OptimizationAction(
                ...
                trade_offs=["Can only iterate once", "Need to handle generators in calling code"]
            ))
