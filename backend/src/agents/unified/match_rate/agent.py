...
class MatchRateAgent(UnifiedBaseAgent):
    ...
    def __init__(self, **kwargs):
        ...
        self.config = {
            ...
            "similarity_methods": ["cosine", "jaccard", "euclidean", "semantic"],
    ...
    def _generate_detailed_analysis(
        self, components: List[Dict], weighted_scores: Dict, ranking: List[Dict]
    ) -> Dict:
    ...
    def _create_error_result(self, error_message: str) -> EnhancedMatchRateResult:
        """Create error result"""
        result = EnhancedMatchRateResult(success=False, data={}, error=error_message)
        return result
