...
class SemanticMatcher:
    ...
    def _analyze_context_alignment(
        self, comp_semantics: Dict, req_semantics: Dict
    ) -> Dict[str, float]:
        ...
        return {
            "sentiment_alignment": self._calculate_sentiment_alignment(
                comp_semantics.get("sentiment", 0), req_semantics.get("sentiment", 0)
            ),
            "complexity_match": self._calculate_complexity_match(
                comp_semantics.get("complexity", 0), req_semantics.get("complexity", 0)
            ),
