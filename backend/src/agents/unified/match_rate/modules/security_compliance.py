...
class SecurityCompliance:
        ...
        for component in components:
            ...
            compliance_checks = {
                "authentication": self._check_authentication_compliance(
                    security_features, security_requirements
                ),
                "authorization": self._check_authorization_compliance(
                    security_features, security_requirements
                ),
    ...
    def _extract_security_features(self, component: Dict) -> Dict[str, Any]:
        ...
        return {
            "has_authentication": any(
                term in text for term in ["authentication", "login", "oauth", "jwt"]
            ),
    ...
    def _check_authentication_compliance(
    ...
    def _check_audit_compliance(self, features: Dict, requirements: Dict) -> Dict[str, Any]:
        ...
        audit_required_for_compliance = any(
            std in ["SOC2", "HIPAA", "PCI-DSS"] for std in compliance_standards
        )
