...
class UnifiedUISelectionAgent(UnifiedBaseAgent):
    ...
    def __init__(self, config: Optional[AgentConfig] = None):
        ...
        self.component_libraries = {
            'material-ui': {
                'components': ['Button', 'TextField', 'Card', 'AppBar', 'Drawer', 'Table', 'Dialog'],
                'style': 'material',
                'pros': ['comprehensive', 'accessible', 'theming'],
                'cons': ['large bundle', 'opinionated']
            },
            'ant-design': {
                'components': ['Button', 'Input', 'Card', 'Layout', 'Menu', 'Table', 'Modal'],
                'style': 'enterprise',
                'pros': ['feature-rich', 'form handling', 'data components'],
                'cons': ['chinese defaults', 'heavy']
            },
            'chakra-ui': {
                'components': ['Button', 'Input', 'Box', 'Stack', 'Grid', 'Modal', 'Toast'],
                'style': 'modern',
    ...
    async def _select_ui_components(
        ...
        component_tree = self._create_component_tree(
            layout,
            components,
            project_type
        )
        ...
        return EnhancedUISelectionResult(
            ...
            performance_considerations=self._get_performance_considerations(library, len(components)),
    ...
    def _create_component_tree(
        ...
        if layout['structure'] == 'sidebar-content':
            tree['children'] = [
                {
                    ...
                    'children': [
                        ...
                        {'name': 'MainContent', 'children': self._get_content_components(project_type)}
                    ]
                }
            ]
            ...
            tree['children'] = [
                ...
                {'name': 'Main', 'children': self._get_content_components(project_type)},
