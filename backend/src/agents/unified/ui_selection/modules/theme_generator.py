...
class ThemeGenerator:
    ...
    def __init__(self):
        ...
        self.spacing_systems = {
            "compact": {"base": 4, "scale": [0, 4, 8, 12, 16, 20, 24, 32, 40, 48]},
            "comfortable": {"base": 8, "scale": [0, 8, 16, 24, 32, 40, 48, 64, 80, 96]},
            "spacious": {
                "base": 12,
        ...
        self.transition_systems = {
            "instant": {"fast": "50ms", "normal": "100ms", "slow": "150ms"},
            "smooth": {"fast": "150ms", "normal": "250ms", "slow": "350ms"},
            "relaxed": {"fast": "250ms", "normal": "400ms", "slow": "600ms"},
        }
    ...
    def generate(
        ...
        component_tokens = self._generate_component_tokens(
            design_system, color_tokens, spacing_tokens
        )
    ...
    def _generate_color_tokens(
        self, brand_colors: Dict[str, str], base_theme: Dict
    ) -> Dict[str, Any]:
    ...
    def _generate_typography_tokens(self, design_system: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "letter_spacing": {"tight": "-0.05em", "normal": "0", "wide": "0.05em"},
        }

    def _generate_component_tokens(
        self, design_system: str, colors: Dict, spacing: Dict
    ) -> Dict[str, Any]:
    ...
    def _create_theme_variants(self, colors: Dict) -> Dict[str, Dict]:
        ...
        return {
            "light": {"colors": colors, "mode": "light"},
            "dark": {"colors": self._create_dark_variant(colors), "mode": "dark"},
            "auto": {
                "colors": colors,
                "mode": "auto",
