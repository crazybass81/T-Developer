...
class TypographySelector:
    ...
    def select(
        ...
        font_stack = self._select_font_stack(
            project_type, brand_personality, preferences, constraints
        )
        ...
        css = self._generate_typography_css(
            font_stack, type_scale, weights, line_heights, letter_spacing
        )
    ...
    def _generate_typography_classes(
        self, type_scale: Dict, weights: Dict, line_heights: Dict
    ) -> str:
