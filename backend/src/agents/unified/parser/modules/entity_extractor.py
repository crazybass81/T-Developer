...
class EntityExtractor:
    ...
    def __init__(self):
        ...
        self.relationship_indicators = {
            ...
            'belongs_to': ['belongs to', 'is part of', 'is in', 'is member of', 'is owned by'],
            ...
            'interacts': ['interacts with', 'communicates with', 'connects to', 'interfaces with'],
        ...
        # Entity modifiers
        self.modifiers = {
            'quantity': ['single', 'multiple', 'many', 'few', 'several', 'all', 'some', 'any'],
            'importance': ['primary', 'secondary', 'main', 'auxiliary', 'critical', 'optional'],
            'state': ['active', 'inactive', 'enabled', 'disabled', 'visible', 'hidden'],
            'access': ['public', 'private', 'protected', 'internal', 'external'],
            'lifecycle': ['new', 'existing', 'updated', 'deleted', 'archived', 'draft', 'published']
        }
        
        # Domain-specific entities
        self.domain_entities = {
            'ecommerce': ['cart', 'checkout', 'shipping', 'inventory', 'discount', 'coupon', 'wishlist'],
            'social': ['feed', 'timeline', 'friend', 'follower', 'like', 'share', 'message', 'notification'],
            'healthcare': ['patient', 'doctor', 'appointment', 'prescription', 'diagnosis', 'treatment'],
            'education': ['course', 'lesson', 'student', 'teacher', 'grade', 'assignment', 'exam'],
            'finance': ['account', 'balance', 'transfer', 'deposit', 'withdrawal', 'statement', 'budget']
        }
                ...
                for entity in entities:
                    ...
                    if key not in seen:
                        ...
                        for existing in merged:
                            if (existing['text'].lower(), existing.get('category')) == key:
    ...
    def _identify_relationship_type(self, entity1: str, entity2: str, sentence: str) -> Optional[str]:
