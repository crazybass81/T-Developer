...
class APIParser:
    ...
    async def parse(self, text: str, entities: Dict[str, Any]) -> List[Dict[str, Any]]:
        """
        ...
        for entity in entity_list:
            ...
            for operation, convention in self.rest_conventions.items():
                ...
                api = {
                    ...
                    "request_body": self._get_request_body_for_method(
                        convention["method"], resource_name
                    ),
    ...
    def _extract_operation_apis(
        ...
        for pattern in operation_patterns:
            ...
            for match in matches:
                ...
                operations.append({"action": action, "resource": resource})
    ...
    def _enhance_parameters(self, parameters: List[Dict]) -> List[Dict]:
        ...
        for param in parameters:
            ...
            # Add schema
            enhanced_param["schema"] = {"type": param.get("type", "string")}
    ...
    def _determine_caching(self, api: Dict) -> Dict:
        ...
        if api["method"] == "GET":
            ...
            if "search" in api["path"] or any(
                p["name"] in ["q", "query", "filter"] for p in api.get("parameters", [])
            ):
                cache["enabled"] = False
    ...
    def _generate_examples(self, api: Dict) -> Dict:
        ...
        if api.get("request_body"):
            examples["request"] = {"name": "Example", "description": "Sample data"}
    ...
    def _generate_gateway_config(self, apis: List[Dict]) -> Dict:
        ...
        return {
            ...
            "globalRateLimit": {"requests": 1000, "window": "1m"},
            "cors": {
                "enabled": True,
                "origins": ["*"],
