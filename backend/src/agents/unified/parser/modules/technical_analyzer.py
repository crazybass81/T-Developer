...
class TechnicalAnalyzer:
    ...
    def __init__(self):
        self.tech_keywords = {
            'platforms': ['web', 'mobile', 'desktop', 'cloud', 'ios', 'android', 'windows', 'linux', 'macos'],
            'frameworks': ['react', 'vue', 'angular', 'django', 'flask', 'spring', 'express', 'fastapi', 'rails'],
            'languages': ['python', 'javascript', 'typescript', 'java', 'csharp', 'golang', 'rust', 'ruby', 'php'],
            ...
            'tools': ['docker', 'kubernetes', 'jenkins', 'github', 'gitlab', 'terraform', 'ansible']
        }
        
        self.architecture_patterns = [
            'microservices', 'monolithic', 'serverless', 'event-driven',
            'layered', 'hexagonal', 'mvc', 'mvvm', 'clean architecture'
        ]
