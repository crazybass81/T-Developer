        ...
        scenarios.append(
            {
                "name": "Happy Path",
                "type": "positive",
                "steps": ["Navigate to feature", "Perform action", "Verify success"],
            ...
            for story2 in stories[i + 1 :]:
                ...
                if story1.get("category") == story2.get("category"):
                    ...
                    if "create" in action1 and any(
                        ...
                        dependencies.append(
                            {"from": story1["id"], "to": story2["id"], "type": "blocks"}
                        )
    ...
    def _calculate_statistics(self, stories: List[Dict]) -> Dict[str, Any]:
        ...
        return {
            ...
            "total_acceptance_criteria": sum(
                len(s.get("acceptance_criteria", [])) for s in stories
            ),
        }
