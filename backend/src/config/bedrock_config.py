...
class BedrockConfig:
    ...
    def from_env(cls, model: BedrockModel = BedrockModel.CLAUDE_3_SONNET) -> 'BedrockConfig':
        ...
        return cls(
            ...
            stop_sequences=os.getenv('BEDROCK_STOP_SEQUENCES', '').split(',') if os.getenv('BEDROCK_STOP_SEQUENCES') else [],
...
class BedrockClient:
    ...
    def invoke_agent(self, agent_id: str, agent_alias_id: str, 
                    session_id: str, input_text: str) -> Dict[str, Any]:
