  ...
  "dependencies": {
    ...
    "react-dom": "^18.2.0"''' + (',\n    "next": "^14.0.0"' if framework == 'nextjs' else '') + '''
        ...
        if 'App' in components or framework == 'react':
            code_files['src/App.js'] = '''import React from 'react';
import './App.css';
...
function App() {
  return (
    <div className="App">
      ...
      ''' + '\n      '.join([f'<{comp.title().replace("_", "")} />' for comp in components if comp not in ['App', '_app', '_document']]) + '''
    </div>
  );
}
  ...
  margin-bottom: 30px;
        ...
        for component in components:
            if component not in ['App', '_app', '_document']:
                ...
                code_files[f'src/components/{comp_name}.js'] = f'''import React from 'react';
...
pydantic>=2.5.0'''
        ...
        # index.html
        code_files['index.html'] = '''<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <script src="app.js"></script>
        ...
        # app.js
        code_files['app.js'] = '''// Production JavaScript Implementation
...
section {
    ...
    # README.md 추가
    code_files['README.md'] = f'''# Generated Project
