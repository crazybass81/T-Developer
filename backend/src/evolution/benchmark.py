...
class AgentBenchmark:
    ...
    def benchmark_agent(self, agent_path: str, iterations: int = None) -> BenchmarkResult:
        ...
        # 제약 조건 확인
        passes = (
            avg_instantiation <= self.TARGET_INSTANTIATION_US and
            memory_kb <= self.TARGET_MEMORY_KB and
            response_time_ms <= self.TARGET_RESPONSE_MS
        )
    ...
    def _calculate_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'avg_instantiation_us': round(statistics.mean(r.instantiation_us for r in self.results), 3),
