    ...
    def _load_aws_config(self):
        ...
        try:
            ...
            if missing:
                ...
                print("\n".join(missing))
                print("\n설정 방법:")
                print(f"1. AWS Secrets Manager에서 't-developer/{self.config_manager.environment}/openai-api-key' 생성")
                print(f"2. AWS Secrets Manager에서 't-developer/{self.config_manager.environment}/anthropic-api-key' 생성")
                print("\nMOCK_MODE로 실행중...")
