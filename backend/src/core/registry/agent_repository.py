...
class AgentRepository:
        ...
        try:
            ...
            if filters:
                ...
                if "created_by" in filters:
                    conditions.append(AgentModel.created_by == filters["created_by"])
    ...
    def _model_to_dict(self, model: AgentModel) -> Dict[str, Any]:
        ...
        return {
            ...
            "ai_confidence_score": float(model.ai_confidence_score)
            if model.ai_confidence_score
            else None,
            "ai_suggestions": model.ai_suggestions,
            "execution_count": model.execution_count,
            "success_count": model.success_count,
            "failure_count": model.failure_count,
            "avg_execution_time_ms": float(model.avg_execution_time_ms)
