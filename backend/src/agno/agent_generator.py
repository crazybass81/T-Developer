...
class AgnoAgentGenerator:
    ...
    async def _query_processor_template(self, blueprint: AgentBlueprint) -> Any:
        ...
        class DynamicQueryProcessor:
            ...
            async def execute(self, operation: str, data: List[Dict], params: Dict[str, Any]) -> Any:
                """쿼리 실행"""
                if operation == 'filter':
            ...
            def _search(self, data: List[Dict], query: str) -> List[Dict]:
                ...
                search_fields = self.config.get('search', {}).get('fields', ['title', 'description'])
    ...
    async def _analytics_template(self, blueprint: AgentBlueprint) -> Any:
        ...
        class DynamicAnalytics:
            ...
            async def generate_report(self, data: List[Dict], report_type: str = 'daily') -> Dict[str, Any]:
                """리포트 생성"""
    ...
    def get_performance_report(self) -> Dict[str, Any]:
        ...
        if self.performance_metrics['generation_time_us']:
            avg_time = sum(self.performance_metrics['generation_time_us']) / len(self.performance_metrics['generation_time_us'])
