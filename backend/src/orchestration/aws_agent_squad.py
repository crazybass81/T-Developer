...
class AWSAgentSquad:
    ...
    async def _execute_agent_locally(self, agent_name: str, input_data: Dict[str, Any]) -> Dict[str, Any]:
        """로컬 Agent 실행"""
        # 간단한 Agent 로직 시뮬레이션
        ...
        agent_results = {
            ...
            "search": {
                ...
                "result": {
                    "templates_found": 3,
                    "best_match": "react-todo-template"
                }
            },
            "generation": {
                "success": True,
        ...
        return agent_results.get(agent_name, {"success": False, "error": f"Unknown agent: {agent_name}"})
