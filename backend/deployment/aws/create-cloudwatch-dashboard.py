...
def create_dashboard():
    ...
    try:
        ...
        response = cloudwatch.put_dashboard(
            DashboardName="T-Developer-Monitoring", DashboardBody=dashboard_body
        )

        print("✅ CloudWatch 대시보드 생성 완료")
        print(
            f"📊 대시보드 URL: https://console.aws.amazon.com/cloudwatch/home?region=us-east-1#dashboards:name=T-Developer-Monitoring"
        )
