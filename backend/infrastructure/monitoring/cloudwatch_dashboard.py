                    ...
                    "properties": {
                        "metrics": [
                            [
                                "TDeveloper",
                                "AgentExecutions",
                                {"stat": "Sum", "label": "Total Executions"},
                            ],
                            [
                                ".",
                                "AgentSuccesses",
                    ...
                    "properties": {
                        "metrics": [
                            [
                                "TDeveloper",
                                "AITokensUsed",
                                {"stat": "Sum", "label": "Total Tokens"},
                            ],
                            [".", "OpenAITokens", {"stat": "Sum", "label": "OpenAI"}],
                            [
                                ".",
                                "AnthropicTokens",
                                {"stat": "Sum", "label": "Anthropic"},
                            ],
                            [
                                ".",
                                "BedrockTokens",
                                {"stat": "Sum", "label": "AWS Bedrock"},
                            ],
                        ],
                        "view": "timeSeries",
                        "stacked": True,
                    ...
                    "properties": {
                        "metrics": [
                            [
                                "TDeveloper",
                                "EvolutionGeneration",
                                {"stat": "Maximum", "label": "Current Generation"},
                            ],
                            [
                                ".",
                                "EvolutionFitness",
                                {"stat": "Average", "label": "Avg Fitness"},
                            ],
                            [
                                ".",
                                "EvolutionBestFitness",
                                {"stat": "Maximum", "label": "Best Fitness"},
                            ],
                        ],
                        "view": "timeSeries",
                        "stacked": False,
                        ...
                        "metrics": [
                            [
                                ...
                                "CPUUtilization",
                                {
                                    "stat": "Average",
                                    "dimensions": {
                                        "ServiceName": f"t-developer-{self.environment}"
                                    },
                                },
                            ],
                            [
                        ...
                        "metrics": [
                            [
                                ...
                                "DatabaseConnections",
                                {
                                    "stat": "Average",
                                    "dimensions": {
                                        "DBClusterIdentifier": f"t-developer-{self.environment}"
                                    },
                                },
                            ],
                            [
                    ...
                    "properties": {
                        "metrics": [
                            [
                                "TDeveloper",
                                "AICostUSD",
                                {"stat": "Sum", "label": "AI API Costs"},
                            ],
                            [
                                ".",
                                "ComputeCostUSD",
                                {"stat": "Sum", "label": "Compute Costs"},
                            ],
                            [
                                ".",
                                "StorageCostUSD",
                                {"stat": "Sum", "label": "Storage Costs"},
                            ],
                        ],
                        "view": "timeSeries",
                        "stacked": True,
