...
secrets_structure = {
    "/t-developer/dev/api-keys/openai": {
        ...
        "value": {
            "api_key": os.environ.get('OPENAI_API_KEY', 'sk-proj-xxx'),  # Will be replaced with actual key
    ...
    "/t-developer/dev/api-keys/anthropic": {
        ...
        "value": {
            "api_key": os.environ.get('ANTHROPIC_API_KEY', 'sk-ant-xxx'),  # Will be replaced with actual key
