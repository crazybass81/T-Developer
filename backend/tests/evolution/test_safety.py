...
from evolution.safety import EvolutionSafety, SafetyConfig, ThreatLevel, PatternType, SafetyViolation
...
"""
    ...
    async def test_resource_pattern_detection(self):
        ...
        # When: 리소스 패턴 검사
        violations = await self.safety._check_resource_patterns("resource_test", resource_intensive_code)
