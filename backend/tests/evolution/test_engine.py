...
from evolution.engine import EvolutionEngine, EvolutionConfig, EvolutionStatus, EvolutionMetrics
...
class TestEvolutionEngine:
    ...
    async def test_selection_process(self):
        ...
        assert sum(parent_fitnesses) / len(parent_fitnesses) >= sum(original_fitnesses) / len(original_fitnesses)
