...
from evolution.registry import AgentRegistry, Agent, AgentType, AgentStatus, AgentMetrics
...
"""
    ...
    async def test_registry_statistics(self):
        ...
        assert all(isinstance(tag_info, tuple) and len(tag_info) == 2 for tag_info in most_common_tags)
