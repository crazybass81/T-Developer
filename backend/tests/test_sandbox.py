...
class TestSandboxConfig:
    ...
    def test_custom_config(self):
        ...
        config = SandboxConfig(cpu_limit=2.0, memory_limit="1g", timeout=600, network_mode="bridge")
    ...
    def test_resource_limits(self):
        ...
        limits = ResourceLimits(cpu=0.5, memory="256m", disk="1g", processes=50)
...
class TestDockerSandbox:
    ...
    async def test_execute_simple_command(self, sandbox):
        ...
        with patch("docker.from_env") as mock_docker:
            ...
            result = await sandbox.execute(command="echo 'Hello World'", timeout=10)
    ...
    async def test_execute_with_timeout(self, sandbox):
        ...
        with patch("docker.from_env") as mock_docker:
            ...
            result = await sandbox.execute(command="sleep 100", timeout=1)
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch("docker.from_env") as mock_docker:
                ...
                result = await sandbox.execute(
                    command="cat test.txt", working_dir=tmpdir, timeout=10
                )
...
"""
        ...
        with patch("docker.from_env") as mock_docker:
            ...
            result = await sandbox.execute_python(script=script, timeout=10)
    ...
    async def test_concurrent_execution(self):
        ...
        with patch("docker.from_env") as mock_docker:
            ...
            tasks = [sandboxes[i].execute(f"echo 'Task {i}'", timeout=10) for i in range(5)]
...
class TestSandboxSecurity:
    ...
    def secure_sandbox(self):
        ...
        policy = SecurityPolicy(
            allow_network=False, allow_privileged=False, blocked_syscalls=["fork", "exec", "ptrace"]
        )
