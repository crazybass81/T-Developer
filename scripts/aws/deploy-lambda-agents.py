...
"""
            ...
            s3_client.upload_file(str(zip_file), self.deployment_bucket, layer_key)
            ...
            try:
                response = lambda_client.publish_layer_version(
                    ...
                    Content={"S3Bucket": self.deployment_bucket, "S3Key": layer_key},
    ...
    def package_agent(self, agent_config: Dict) -> str:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            s3_client.upload_file(str(zip_file), self.deployment_bucket, s3_key)
            ...
            if e.response["Error"]["Code"] == "ResourceNotFoundException":
                ...
                try:
                    lambda_client.create_function(
                        ...
                        Role=role_arn,
                        Handler=agent_config["handler"],
                        Code={"S3Bucket": self.deployment_bucket, "S3Key": s3_key},
                        Description=agent_config["description"],
                        Timeout=agent_config["timeout"],
                        MemorySize=agent_config["memory"],
                        Environment={
...
def main():
    ...
    parser.add_argument("--test", action="store_true", help="Test deployed functions")
