                ...
                if self.token:
                    ...
                    for line in logs.split('\n'):
                        ...
                        if any(keyword in line_lower for keyword in 
                               ['error:', 'error process', 'failed', 'failure', 
                                'exception', 'traceback', 'syntaxerror', 'typeerror',
...
def main():
    ...
    parser.add_argument('--repo', default='crazybass81/T-DeveloperMVP', 
