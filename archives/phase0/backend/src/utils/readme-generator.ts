...
export class ReadmeGenerator {
  ...
  private constructor(private templatePath: string) {}
  
  static async create(templatePath: string): Promise<ReadmeGenerator> {
    const generator = new ReadmeGenerator(templatePath);
